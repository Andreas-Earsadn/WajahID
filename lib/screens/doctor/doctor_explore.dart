...
class ExploreDoctorPage extends StatefulWidget {
  const ExploreDoctorPage({Key key, this.callBack}) : super(key: key);
  // final DoctorModel doctorList;
  final Function() callBack;

  @override
  _ExploreDoctorPageState createState() => _ExploreDoctorPageState();
}

class _ExploreDoctorPageState extends State<ExploreDoctorPage>
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text(
                      'South Jakarta',
                      style: TextStyle(color: WajahColors.WajahPrimary),
                    ),
                  ],
                ),
                Row(
  ...
  allDoctorList(ClinicDoctor clinicDoctor) {
    return AspectRatio(
      aspectRatio: 1 / 1,
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    "\$ " + clinicDoctor.price.toString() + '.00',
                    style: TextStyle(
                        color: Colors.black,
                        fontSize: 18,
