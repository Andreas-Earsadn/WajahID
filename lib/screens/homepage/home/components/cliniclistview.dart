...
class ClinicListView extends StatefulWidget {
  const ClinicListView({Key key, this.callBack}) : super(key: key);
...
class _ClinicListViewState extends State<ClinicListView> with TickerProviderStateMixin {
            ...
            if (!snapshot.hasData) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  return ClinicView(
                    clinic: Clinic.popularClinicList[index],
                    animation: animation,
                    animationController: animationController,
